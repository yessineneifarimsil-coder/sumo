...
Note: the roundabout node IDs here were sourced from scripts/roundabouts.txt
(rb1:-836, rb2:-3156, rb3:-3194, rb4:-3185) and manually enriched with
connecting-street names and descriptions. Signal node IDs (-3115, -3121,
-5174) match signals/feux_route_tunis.add.xml.
"""
...
def export_to_json():
    ...
    with open("../docs/generated/route_de_tunis_infrastructure.json", "w", encoding="utf-8") as f:
...
def export_to_csv():
    ...
    # Signals CSV
    with open("../docs/generated/traffic_signals_inventory.csv", "w", newline="", encoding="utf-8") as f:
    ...
    # Roundabouts CSV
    with open("../docs/generated/roundabouts_inventory.csv", "w", newline="", encoding="utf-8") as f:
...
"""
    ...
    with open("../docs/generated/infrastructure_specification.md", "w", encoding="utf-8") as f:
        f.write(md_content)
...
if __name__ == "__main__":
    ...
    print("\nFiles created (in docs/generated/):")
